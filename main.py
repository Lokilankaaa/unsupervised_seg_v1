...
def get_argparser():
    ...
    parser.add_argument("--model", type=str, default='deeplabv3plus_mobilenet',
                        choices=['deeplabv3_resnet50', 'deeplabv3plus_resnet50',
                                 ...
                                 'deeplabv3_mobilenet', 'deeplabv3plus_mobilenet'], help='network name')
...
def main():
    ...
    # optimizer = torch.optim.SGD(params=network.parameters(), lr=opts.lr, momentum=0.9, weight_decay=opts.weight_decay)
